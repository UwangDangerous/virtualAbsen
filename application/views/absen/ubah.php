...
<form action="" method="post">
    ...
    <input type="text" name="judul" id="judul" class='form-control mb-3' value="<?= $absen['judul'] ;?>">
    ...
    <input type="date" name="tgl_absen" id="tgl_absen" class='form-control mb-3' value="<?= $absen['tgl_absen'] ;?>">
    ...
    <input type="number" name="meeting" id="meeting" class='form-control mb-3' value="<?= $absen['meeting'] ;?>">
